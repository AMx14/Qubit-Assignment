...
from src.db.operations import add_company, get_company_by_id, get_enriched_company_by_id
from src.api.enrich import enrich_company_data
...
def get_company_endpoint():
    try:
        ...
        print("Invalid input. Please enter a valid integer for company ID.")
